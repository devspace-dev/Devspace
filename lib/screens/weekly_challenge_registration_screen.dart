  ...
  Widget _buildEnrollmentView() {
    ...
    return Column(
      ...
      children: [
        ...
        _buildBulletPoint('Personalized feedback from elite mentors'),
        _buildBulletPoint('Verified badge for your profile'),
        _buildBulletPoint('Visibility on global leaderboards'),
        const SizedBox(height: 24),
