...
class _WeeklyFreeChallengeScreenState extends State<WeeklyFreeChallengeScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (provider.weeklyFreeChallenge == null) {
  ...
  Future<void> _submit(EngagementProvider provider) async {
    ...
    if (success) {
      final challenge = provider.weeklyFreeChallenge;
      final solved = challenge?.wasSolved ?? false;
      final awardedPoints =
          solved ? (challenge?.pointsReward ?? 50) : DailyChallengeModel.attemptReward;
        ...
        SnackBar(
          content: Text(
            solved
                ...
                : 'Wrong answer. +$awardedPoints Aura for attempting.',
          ),
                ...
                SliverToBoxAdapter(
                  child: Consumer<EngagementProvider>(
                    builder: (context, provider, _) {
                      if (provider.isLoading && provider.weeklyFreeChallenge == null) {
                        return const Center(
                          child: Padding(
                      ...
                      if (challenge == null) {
                        return const AppEmptyState(
                          ...
                          message: 'Check back later for a new weekly free challenge.',
                        );
                      }
                      ...
                      return Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            _buildChallengeHeader(context, me, challenge),
                            const SizedBox(height: 24),
                            _buildMainCard(context, challenge),
                            const SizedBox(height: 24),
                            if (!challenge.completed) _buildActionSection(context, provider),
                            if (challenge.completed) _buildCompletionStatus(context, challenge),
  ...
  Widget _buildChallengeHeader(BuildContext context, dynamic me, DailyChallengeModel challenge) {
    return Wrap(
      spacing: 12,
      runSpacing: 12,
      children: [
        ...
        _HeaderBadge(
          label: '+${challenge.pointsReward} Aura Reward',
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  solved ? 'Challenge solved' : 'Challenge attempted',
                  style: TextStyle(
                    fontWeight: FontWeight.w900,
                    fontSize: 18,
                    color: accent,
                ...
                Text(
                  solved
                      ? 'You earned +$points Aura points. Weekly goal progress updated!'
                      : 'You earned +$points Aura for trying.',
                  style: TextStyle(
                    fontSize: 14,
                      ...
                      child: Opacity(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: const Color(0xFF00C6FF).withValues(alpha: 0.32),
                                blurRadius: 30,
                                spreadRadius: 4,
                              ),
                            ],
