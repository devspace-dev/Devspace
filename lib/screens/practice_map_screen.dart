...
class _PracticeMapScreenState extends State<PracticeMapScreen>
  ...
  Widget _buildPathNodeRow({
    ...
    // Current active node is unlocked but not yet completed (or the latest available unlocked node)
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: [
          ...
          // Level Node Button
          Transform.translate(
            offset: Offset(curveOffset * 110, 0),
            child: Column(
                ...
                GestureDetector(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      // Node Circle Base
                      Container(
                        width: isSpecialMilestone ? 74 : 66,
                        height: isSpecialMilestone ? 74 : 66,
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          gradient: LinearGradient(
                            begin: Alignment.topLeft,
  ...
  double _getCurveOffset(int index) {
    // S-curve pattern: [0.0, 0.45, 0.70, 0.45, 0.0, -0.45, -0.70, -0.45]
...
class PathConnectorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double startX = size.width / 2 + (startOffset * 110);
    final double startY = 0;
    final double endX = size.width / 2 + (endOffset * 110);
