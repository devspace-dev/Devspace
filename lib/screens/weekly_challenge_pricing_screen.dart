...
class WeeklyChallengePricingScreen extends StatefulWidget {
  const WeeklyChallengePricingScreen({super.key});

  @override
  State<WeeklyChallengePricingScreen> createState() => _WeeklyChallengePricingScreenState();
}

class _WeeklyChallengePricingScreenState extends State<WeeklyChallengePricingScreen> {
  int _selectedTab = 1; // Default to PREMIUM
                ...
                child: AnimatedSwitcher(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: _selectedTab == 0 
                      ...
                      : _buildPremiumTier(context, premium),
                  ),
                ),
              ),
            ],
  ...
  Widget _buildPremiumTier(BuildContext context, PremiumProvider premium) {
    String buttonText = 'Unlock Premium Access';
    VoidCallback? onPressed;

    if (premium.isPremium) {
      buttonText = 'Explore Premium for a month';
      onPressed = () {
        Navigator.push(
          context,
      ...
      onPressed = () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const WeeklyChallengeRegistrationScreen()),
        );
      };
    }
    ...
    return Column(
      children: [
        ChallengeTierCard(
          ...
          isEnrolled: premium.isPremium,
          isLoading: premium.isLoading,
          features: const [
            'Personalized Weekly Questions',
